...
public:
	...
	static void MakeCreateMyCharacter(Jay::NetPacket* packet, INT64 clientID, BYTE characterType, WCHAR* nickname, float fieldX, float fieldY, USHORT rotation, int cristal, int hp, INT64 exp, USHORT level);
	static void MakeCreateOtherCharacter(Jay::NetPacket* packet, INT64 clientID, BYTE characterType, WCHAR* nickname, float fieldX, float fieldY, USHORT rotation, USHORT level, BYTE respawn, BYTE sit, BYTE die);
	static void MakeCreateMonster(Jay::NetPacket* packet, INT64 clientID, float fieldX, float fieldY, USHORT rotation, BYTE respawn);
	static void MakeDeleteObject(Jay::NetPacket* packet, INT64 clientID);
	static void MakeMoveCharacterStart(Jay::NetPacket* packet, INT64 clientID, float fieldX, float fieldY, USHORT rotation, BYTE vKey, BYTE hKey);
	static void MakeMoveCharacterStop(Jay::NetPacket* packet, INT64 clientID, float fieldX, float fieldY, USHORT rotation);
	static void MakeMoveMonster(Jay::NetPacket* packet, INT64 clientID, float fieldX, float fieldY, USHORT rotation);
	...
	static void MakeCreateCristal(Jay::NetPacket* packet, INT64 clientID, BYTE cristalType, float fieldX, float fieldY);
