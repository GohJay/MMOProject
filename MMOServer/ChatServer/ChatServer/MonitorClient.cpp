...
void MonitorClient::MonitoringProc()
{
	...
	Update(dfMONITOR_DATA_TYPE_CHAT_PACKET_POOL, _chat->GetUsePacketCount(), timer);
	...
	Update(dfMONITOR_DATA_TYPE_MONITOR_NETWORK_RECV, _processerUsage.GetNetworkRecvMbit(), timer);
	Update(dfMONITOR_DATA_TYPE_MONITOR_NETWORK_SEND, _processerUsage.GetNetworkSendMbit(), timer);
