...
enum en_PACKET_CS_GAME_RES_LOGIN 
{
	...
	dfGAME_LOGIN_NOPLAYER		= 2,			// 성공 / 캐릭터 없음 > 캐릭터 선택화면으로 전환. 
...
enum en_PACKET_MONITOR_SERVER_NO
{
	dfMONITOR_SERVER_NO_GAME	= 1,
	dfMONITOR_SERVER_NO_CHAT	= 2,
	dfMONITOR_SERVER_NO_LOGIN	= 3,
};
